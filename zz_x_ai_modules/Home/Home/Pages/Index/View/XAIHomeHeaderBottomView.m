...
@interface XAIHomeHeaderBottomView ()
...
@implementation XAIHomeHeaderBottomView
...
- (UIButton *)hotBtn {
    if (!_hotBtn) {
        ...
        [_hotBtn setTitle:@"语文" forState:(UIControlStateNormal)];
...
- (UIButton *)historyBtn {
    if (!_historyBtn) {
        ...
        [_historyBtn setTitle:@"数学" forState:(UIControlStateNormal)];
