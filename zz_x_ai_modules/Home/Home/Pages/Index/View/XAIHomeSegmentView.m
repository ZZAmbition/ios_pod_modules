...
@interface XAIHomeSegmentView ()
@property (nonatomic,strong) UIButton *hotBtn;
@property (nonatomic,strong) UIButton *historyBtn;

@end

@implementation XAIHomeSegmentView
...
- (UIButton *)hotBtn {
    if (!_hotBtn) {
        ...
        [_hotBtn setTitle:@"化学" forState:(UIControlStateNormal)];
...
- (UIButton *)historyBtn {
    if (!_historyBtn) {
        ...
        [_historyBtn setTitle:@"物理" forState:(UIControlStateNormal)];
